/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 04315d5279d96bdb72486fd840fe62d2)
...
interface __BaseEnv_Env {
	...
	API_ANALYTICS_SAMPLE_RATE: string;
	ADMIN_USER: string;
	ADMIN_PASS: string;
	JWT_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PINGFLARE_INSTANCE_ID" | "API_ANALYTICS_SAMPLE_RATE" | "ADMIN_USER" | "ADMIN_PASS" | "JWT_SECRET" | "ENCRYPTION_KEY">> {}
}
